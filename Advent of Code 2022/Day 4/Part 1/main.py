...
sum_of_the_prioritie = 0

rucksacks = list(zip(*[iter(rucksacks)]*3))

for i, rucksack in enumerate(rucksacks):
    rucksack_1, rucksack_2, rucksack_3 = rucksack
    for letter in rucksack_1:
        if letter in rucksack_2:
            if letter in rucksack_3:
                item_priority = ord(letter)
                if item_priority >= 97:
                    sum_of_the_prioritie += (item_priority-96)
                else:
                    sum_of_the_prioritie += (item_priority-38)
                break

print("Find the item type that appears in both compartments of each rucksack. What is the sum of the priorities of those item types?","Answer:",sum_of_the_prioritie)
